        ...
        for idx, tensor_paras in enumerate(tensor_paras_list):
            for tensor_para in tensor_paras:
                if tensor_para["ins"] in device_tensor_paras:
                    if ("value" in tensor_para and tensor_para["value"] in device_tensor_paras[tensor_para["ins"]]["value"]) \
                            or ("shape" in tensor_para and tensor_para["shape"] in device_tensor_paras[tensor_para["ins"]]["shape"]):
