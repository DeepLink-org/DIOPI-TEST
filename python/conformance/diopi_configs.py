...
diopi_configs = {
            ...
            args=[
                {
                    "ins": ["input"],
                    "requires_grad": [True],
                    "shape": ((2, 256, 200, 304), (2, 2048, 64, 64),
                              (2, 2048, 1, 1), (2, 256, 200, 304)),
                },
                {
                    "ins": ["weight"],
                    "requires_grad": [True],
                    "shape": ((12, 256, 1, 1), (2048, 1, 3, 3),
                              (512, 2048, 1, 1), (12, 256, 1, 1)),
                },
                {
                    "ins": ["bias"],
                    "requires_grad": [True],
    ...
    'normal_': dict(
        ...
        no_output_ref=True,
        para=dict(
            mean=[0, 2, 0.1, 0.5, True, False],
            std=[0.5, 1, 2, 3.14, True, True],
        ),
        tensor_para=dict(
            gen_fn=Genfunc.randn,
            args=[
